...
import { coffee as coffees } from "../../../data.json";
...
export function CartPage() {
  const {
    ...
    watch,
    register,
  } = useForm<FormInputs>({ resolver: zodResolver(newOrderSchema) });
  ...
  const totalItemsPrice = coffeesInCart.reduce((prevValue, currentItem) => {
